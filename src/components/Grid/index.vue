...
import { onBeforeMount, onMounted, onActivated, onUnmounted, onDeactivated, provide, ref, useSlots, watch, computed } from "vue";
...
const findIndex = () => {
    ...
    try {
        ...
        fields.reduce((prev = 0, current, index) => {
            ...
            let cols: number = gridCols.value as number;
            if (Number(prev) > props.collapsedRows * cols - suffixCols) {
