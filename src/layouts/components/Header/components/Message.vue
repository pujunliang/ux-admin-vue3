        ...
        <el-popover
            ...
            <template #reference>
                <el-badge
                    :value="5"
                    class="item">
                    <i class="ri-notification-line toolBar-icon"></i>
                </el-badge>
            </template>
                    ...
                    <div class="message-list">
                        <div class="message-item">
                            ...
                            <div class="message-content">
                                <span class="message-title">一键三连 Ux-Admin 🧡</span>
